...
import 'package:prodox/services/ProductivityModel.dart';
import 'package:intl/intl.dart';

import '../../../common/styles/styles.dart';
import '../../../services/category_model.dart';
import '../../../services/weekly.dart';
...
class _WeeklyChartState extends State<WeeklyChart> {
  late Future<List<Routine>> futureWeeklyRoutines;
  ...
  static BarChartGroupData generateGroupData(
      int x, Routine routine,
      bool hasData,
      Map<TaskCategory, int> totalCategoryDurations,
    ...
    if (hasData) {
      ...
      List<TaskCategory> sortedCategories = TaskCategory.values;
        ...
        if (categoryDuration > 0) {
          barRods.add(
            BarChartRodData(
              ...
              toY: cumulativeDuration + categoryDuration, // Correctly add categoryDuration to cumulativeDuration
  ...
  static List<BarChartGroupData> getChartGroups(List<Routine> weeklyRoutines, DateTime currentDate) {
    Map<TaskCategory, int> totalCategoryDurations = ProductivityModel.calculateTotalCategoryDuration(weeklyRoutines.take(1).toList());
